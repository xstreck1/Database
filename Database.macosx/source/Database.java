...
class Data {
  ...
  public void password() {
    ...
    if (valid.substring(0,6).contentEquals("DENIED") || valid.substring(0,2).contentEquals("OK") || valid.substring(0,2).contentEquals("AB") || valid.substring(0,3).contentEquals("NOT")) {
...
public class Dimensions {
  ...
  Dimensions() {
    ...
    border_y = round(height * 0.05f);
    border_x = round(height * 0.05f) + round((width_ - height*1.3f)/2.0f);
    basic_key_size = round(height *0.1f);
